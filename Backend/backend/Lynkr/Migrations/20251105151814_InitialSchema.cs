...
namespace Lynkr.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Content", "CreatedAt", "ImageUrl", "UserId" },
                values: new object[,]
                {
                    { 1, "First post from Alice!", new DateTimeOffset(new DateTime(2025, 1, 10, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "https://placehold.co/100x100/2196F3/white?text=B", 1 },
                    { 2, "Bob checking in with a new post.", new DateTimeOffset(new DateTime(2025, 1, 11, 14, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "https://placehold.co/100x100/2196F3/white?text=B", 2 }
                });
